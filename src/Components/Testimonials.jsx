        ...
        <div className="mx-auto  lg:px-20 px-3 ">
          <div className="flex justify-center items-center gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8 max-w-sm sm:max-w-2xl lg:max-w-full mx-auto">
            <div className="w-full lg:w-2/5">
              ...
              <h2 className="text-4xl font-bold text-[#023769] leading-[3.25rem] mb-8">
              Hear How Educatia Transformed {" "}
                <span className=" bg-clip-text text-black">
                  Lives
                </span>
              </h2>
              <p>At Educatia, we’ve helped countless students turn their study abroad dreams into reality. See how we’ve empowered others to achieve global success.</p>
